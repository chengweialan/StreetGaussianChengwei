...
def save_point_cloud_to_ply(point_xyz_world, ply_filename):
    # 将点云数据转换为 Open3D 点云格式
    point_cloud = o3d.geometry.PointCloud()
    point_cloud.points = o3d.utility.Vector3dVector(point_xyz_world)
...
def readVKittiInfo(args):
    ...
    points = []
    points_time = []
    scale_factor = 50 # Scale factor for the depth
    ...
    save_point_cloud_to_ply(camera_positions,'/home/chengwei/Desktop/summer_research/SUDS/depth_recover/vkitti2/Scene01/clone/ply/camera_before.ply')
    ...
    for idx in tqdm(range(len(c2ws)), desc="Loading data"):
        ...
        file_path='/home/chengwei/Desktop/summer_research/SUDS/depth_recover/vkitti2/Scene01/clone/ply'
        file_path=os.path.join(file_path,f'{idx}_depth.ply')
        save_point_cloud_to_ply(point_xyz_world,file_path)
    ...
    save_point_cloud_to_ply(camera_positions,'/home/chengwei/Desktop/summer_research/SUDS/depth_recover/vkitti2/Scene01/clone/ply/camera_after.ply')
...
def visualize_multiple_point_clouds(ply_files, bin_files, axis_size=1.0, point_size=2.0):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_pts", type=int, default=1000000)
    ...
    ply_files = ['/home/chengwei/Desktop/summer_research/SUDS/depth_recover/vkitti2/Scene01/clone/ply/0_depth.ply','/home/chengwei/Desktop/summer_research/SUDS/depth_recover/vkitti2/Scene01/clone/ply/1_depth.ply','/home/chengwei/Desktop/summer_research/SUDS/depth_recover/vkitti2/Scene01/clone/ply/2_depth.ply']
